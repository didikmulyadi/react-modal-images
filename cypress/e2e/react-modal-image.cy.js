...
describe("react-modal-images", function () {
  ...
  it("can open and close the three first lightboxes", function () {
    ...
    cy.get("#react-modal-images-img").should("not.exist");

    for (let idx of [0, 1, 2]) {
      cy.get(`img:nth(${idx})`).click();
      cy.get("#react-modal-images-img");
    ...
    for (let idx of [0, 1, 2]) {
      ...
      cy.get("span.__react_modal_image__icon_menu")
        ...
        .then(($zoom1) => {
          ...
          // doubleclicks
          cy.get("#react-modal-images-img").dblclick();
  ...
  it("zoom and download buttons are hidden in the fourth lightbox", function () {
    ...
    cy.get(".react-modal-images-zoom").should("not.exist");
  ...
  it("fifth image has hotpink background", function () {
    ...
    cy.get(".__react_modal_image__medium_img").should(
      "have.css",
      "background-color",
      "rgb(255, 105, 180)"
    );
